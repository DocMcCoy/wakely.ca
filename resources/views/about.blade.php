...
<main class="about-main">
    ...
    <div class="speech-card-left">
        ...
        <img class="profile-circle" src="/img/profile/david-wakely-1.png" title="David Wakely talking head for speech balloon" alt="David Wakely talking head for speech balloon" height="500px">
    </div>
    <div class="speech-card-right">
        ...
        <img class="profile-circle" src="/img/profile/david-wakely-2.png" title="David Wakely talking head for speech balloon" alt="David Wakely talking head for speech balloon" height="500px">
    </div>
    ...
    <div class="speech-card-left">
        ...
        <img class="profile-circle" src="/img/profile/david-wakely-3.png" title="David Wakely talking head for speech balloon" alt="David Wakely talking head for speech balloon" height="500px" class="right">
    </div>
    <div class="speech-card-right">
        <blockquote class="rectangle-speech-border-right">
        ...
        <img class="profile-circle" src="/img/profile/david-wakely-4.png" title="David Wakely talking head for speech balloon" alt="David Wakely talking head for speech balloon" height="500px" class="right">
    </div>
</main>
@endsection
